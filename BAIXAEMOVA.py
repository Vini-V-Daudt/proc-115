...
from_dir = "C:/Users/vv226/Downloads"
to_dir = "C:/Users/vv226/Downloads/2"
        ...
        for key, value in dir_tree.items():
            ...
            if extension in value:
                ...
                if os.path.exists(path2):
                    print("acessamdo destino existente")
                    time.sleep
                    

# Verifica se o arquivo já existe na categoria de destino
                    if os.path.existis(path3):
                        print("o arquivo ja existe" + key + "....")
                        print("renomeado como" + file_name)
                    
                    
                    
                        
                        # Renomeia o arquivo com um número aleatório
                        new_file_name = os.path.splittext(file_name)[0] + str(random.randit(0, 999)) + os.path.splittext(file_name)[1]
